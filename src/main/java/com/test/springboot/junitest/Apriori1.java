...
public class Apriori1 {
	...
	/**
	 * 这个是用来找出1-频繁项集的方法，因为1-频繁项集的特殊性， 所以需要特别的方法来返回1-频繁项集
	 * 
	 * @param dataList
	 * @return
	 */
	...
	private List<String> subset(String sourceSet) {
		...
		/*
		 * 如集合A={a,b,c},对于任意一个元素，在每个子集中，要么存在，要么不存在。 映射为子集： (a,b,c) (1,1,1)->(a,b,c)
		 * (1,1,0)->(a,b) (1,0,1)->(a,c) (1,0,0)->(a) (0,1,1)->(b,c) (0,1,0)->(b)
		 * (0,0,1)->(c) (0,0,0)->@(@表示空集)
		 */
		...
		for (String key : KeySet) {
			...
			for (String keySubSetItem : keySubset) {
				...
				if (count != null) {
					/*
					 * 置信度
					 * 置信度(confidence)揭示了A出现时B是否一定出现，如果出现，则出现的概率是多大。如果A->B的置信度是100%，则说明A出现时B一定会出现（
					 * 返回来不一定）。 上图中底板共出现5次，其中4次同时购买了胶皮，底板->胶皮的置信度是80%。 用公式表示是，物品A->B的置信度=物品{A,B}的支持度
					 * / 物品{A}的支持度： Confidence(A->B) = support({A,B}) / support({A}) = P(B|A)
					 */
	 ...
	 * 将txt中的二维表读入T中
	 * 
	 * @param filePath TXT的文件路径，注意文件路径分隔符必须写成\\
	...
	public static void main(String[] args) {
		...
		dataList.add("A1;A2;A3;A6;A8;A9;B1;B3;C4;C5;C6;D1;D3;D5;E1;E2;");
		dataList.add("A1;A3;A9;B3;C3;C5;C7;D3;D5;E1;E2;");
		dataList.add("A3;A6;A9;B3;C4;C6;D3;E1;");
		dataList.add("A2;A3;A5;A7;A9;B1;C3;C4;C5;D1;E1;E2;");
		dataList.add("A1;A2;A3;A5;A6;A9;B3;C1;C4;C5;C7;D1;D3;D5;E1;E2;");
		dataList.add("A1;A4;A9;B2;B3;B4;C2;C4;C6;C7;D3;D4;");
		dataList.add("A2;A3;A6;A8;A9;B3;B4;C1;C3;D1;D3;D5;");
		dataList.add("A3;A4;A5;B1;C3;C5;C6;D2;E1;");
		dataList.add("A1;A3;A4;A6;A9;B1;B4;C6;D1;");
		dataList.add("A3;A9;B1;B3;B4;C6;D1;");
		dataList.add("A3;A5;A8;B1;C4;C5;C7;D3;E1;E2;");
		dataList.add("A1;A5;A8;A9;B1;C5;C7;D3;E1;E2;");
		dataList.add("A1;A3;A5;A8;A9;B1;C5;C6;D3;E1;");
		dataList.add("A1;A3;A5;A8;A9;B1;C5;C6;D3;E1;");
		dataList.add("A1;A3;A6;A8;B1;B4;C4;C5;D1;D4;E2;");
		dataList.add("A1;A6;A8;B1;B4;C4;C7;D3;D5;E1;");
		dataList.add("A1;A6;A8;A9;B1;B3;B4;C4;D1;D4;E1;");
		dataList.add("A1;A6;A8;B1;B4;C1;C2;C7;D1;D3;D5;E1;");
		dataList.add("A3;A7;B2;C4;C6;D1;D4;E1;E2;");
		dataList.add("A1;A8;A9;B4;C2;C6;D1;D5;");
		dataList.add("A3;A5;A6;A8;B2;C5;C6;D3;D5; E1; E2;");
		dataList.add("A2;A3;A4;A8;B1;B4;C6;D3;");
		dataList.add("A1;A3;A9;B1;B4;C6;D1;D5;E1;");
		dataList.add("A1;A3;A8;B1;B4;C6;D1;D5; E2;");
		dataList.add("A3;A7;B1;C5;C6;D1;E1;");
		dataList.add("A3;A5;A8;B1;C6;C7;D1;E1;");
		dataList.add("A3;A7;A8;B1;C6;C7;D1;E1;");
		dataList.add("A3;A7;A8;B1;C6;C7;D1;E1;");
		dataList.add("A1;A3;A7;A8;B1;C5;C6;D3;D5;E1;");
		dataList.add("A1;A3;A5;A6;B1;C3;C6;D1;D5;");
